use genesis_config::{GenesisButton, GenesisEmulatorConfig, GenesisInputs};
use genesis_core::api::{GenesisEmulator, GenesisHardware};
...
const MAX_TICKS_PER_FRAME: usize = 2_000_000;
...
fn update_inputs(inputs: &mut GenesisInputs) {
    // Genesis face layout: X/Y/Z are the upper row and A/B/C are the lower row.
    let mappings = [
        (GenesisButton::B, BTN_A),
        (GenesisButton::C, BTN_B),
        (GenesisButton::A, BTN_X),
        (GenesisButton::Y, BTN_Y),
        (GenesisButton::X, BTN_L),
        (GenesisButton::Z, BTN_R),
        (GenesisButton::Mode, BTN_SELECT),
        (GenesisButton::Start, BTN_START),
        (GenesisButton::Up, BTN_UP),
        (GenesisButton::Down, BTN_DOWN),
        (GenesisButton::Left, BTN_LEFT),
        (GenesisButton::Right, BTN_RIGHT),
    ];
